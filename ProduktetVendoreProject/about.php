    ...
    <div class="content">
        <div class="container">
            <div class="blej-shqip">
                ...
                <?php
                if(isset($_SESSION['logged_in'])) {?>
                    <a href="about_add.php" class="btn btn-info">add</a>
                <?php } ?>
               <!--     <a href="about_modify.php" class="btn btn-info">modify</a> -->
                </div><!-- /.about-buttons -->
                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <?php
                           if(isset($_SESSION['logged_in']))
                        {
                           echo"<a href=\"about_modify.php?IDg=".$row["Id"]."\" class=\"btn btn-info\">modify</a>";
                        }
                        ?>
                            </div>
                    ...
                    <div class="col-sm-4">
                        <aside>
                            <img src="images/duaje-tenden.jpg" alt="Duaje Tenden">
                            <img src="images/blejshqip.jpg" alt="Bleje Shqip">
                            <img src="images/blej-shqip-logo.jpg" alt="Bleje Shqip">
                        </aside>
                    </div>
                </div>
            </div>
