...
<html lang="en">
  ...
  <body>
    ...
    <div class="content">
        ...
        <!-- === MAP ===-->
            <div class="map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d46940.16238164286!2d21.123707926874317!3d42.66643787988073!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13549ee605110927%3A0x9365bfdf385eb95a!2sPrishtina!5e0!3m2!1sen!2s!4v1446541212261" width="100%" height="250" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
            <h2>Contact Us</h2>
            <div class="contact-form">
                    ...
                    //define variablas
                    $name_surname = $email = $tel = $subject = $comment = "";
                        ...
                        if($_SERVER["REQUEST_METHOD"] == "POST")
                        {
                            ...
                            $emailbody = 'Full Name' . $name_surname . "\n" . 'Email' . $email . "\n" . 'tel' . $tel . "\n" . 'subject' . $subject . "\n" . 'comment' . $comment;                       
                            mail('someone@example.com', 'Subject line', $emailbody);

                        }
                        else
                        {
                            //header('location: send_email.php');
                            //echo "Email nuk eshte derguar !";
                    ...
                    ?>
                                    <form id="contact-form" method = "POST" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> 
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name_surname" id="name_surname" placeholder="Name and Surname" required>
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" name="tel" id="tel" placeholder="Telephone" required>
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <button type="submit" name="send" id="send" class="btn btn-default">Submit</button>
                                    </form>
                                    <?php
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="contact-info">
                                <p><span class="font-bold">Location: </span> Put interdum tristique est commodo pharetra.</p>
                                <hr>
                                <p><span class="font-bold">Address: </span> Lorem Ipsum is simply dummy text of the printing and over.</p>
                                <hr>
                                <p><span class="font-bold">Telephone: </span> +377 44 12 34 56</p>
                                <hr>
                                <p><span class="font-bold">E-mail: </span> someone@example.com</p>
                                <hr>
                                <p>
                                ...
                                <p><span class="font-bold">Follow Us: </span></p>
