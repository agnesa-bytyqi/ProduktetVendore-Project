  ...
  <body>
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="companies.html">Companies</a></li>
    ...
    <div class="content">
        <div class="container">
            ...
            <h2>Companies</h2>
            <div class="companies">	
               <table id="table-companies" class="display" cellspacing="0" width="100%">
                    <thead>
                       <tr>
                            <th>Company Name</th>
...
$company_name=$company_location=$product_name = "";

$sql="SELECT ID, company_name, company_location,product_name FROM company_add";
    ...
    while($row = $result->fetch_assoc()) 
       ...
       // echo "<tr><td>".$row["id"]."</td><td>".$row["firstname"]." ".$row["lastname"]."</td></tr>";
             ...
             //if(isset($login_session))
               ...
               echo "<tr>".
                 "<td>"."<a href=\"company.php?IDp=".$row['ID']."\">$company_name</a></td>".
            	 "<td>"."<a href=\"product.php?IDp=".$row['ID']."\">$product_name</a></td>".
                 "<td>"."<a href=\"company.php?IDp=".$row['ID']."\">$company_location</a></td>".	
                "</tr>";
            

    }
    }else {
        echo "Nuk gjindet asnje kompani ne databaze !";
    }
$conn->close();
?>
