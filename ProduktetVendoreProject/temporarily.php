                        ...
                        <div class="account">
                            <div class="row">
                                <div class="col-sm-3 col-xs-3">
                                    ...
                                    <p><a href="temporarily.html">account</a></p>
                                </div>
                                <?php
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="temporarily.php">Temporarily</a></li>
...
if ($result->num_rows > 0) {
	...
	?> 
            <div class="new-product">
             ...
             <div class="col-sm-6">
                        ...
                        <div class="company-title">
                            <p>Company: <span class="value"><?php echo $row["company_name"];?></span></p>
                       </div>
                        <div class="company-location">
                            <p>Location: <span class="value"><?php echo $row["company_location"];?></span></p>
                        </div>
                        <div class="company-address">
                            <p>Address: <span class="value"><?php echo $row["company_address"];?></span></p>
                        </div>
                        <div class="company-contact">
                            <p>Tel: <span class="value">
							<?php echo $row["company_tel"];?></span></p>
                            <p>Email: <span class="value"><?php echo $row["company_email"];?></span></p>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="company-image">
                            <img src="repository/images/<?php echo $row["product_image"]; ?>" alt="Product Image">
                        </div>
                        <div class="company-product-title">
                            <p>Product: <span class="value"><?php echo $row["product_name"];?></span></p>
                        </div>
                        <div class="company-product-barcode">
                           <p>Barcode: <span class="value"><?php echo $row["product_id"];?></span></p>
                        </div>
                        <div class="company-product-category">
                            <p>Category: <span class="value"><?php echo $row["product_category"];?></span></p>
                        </div>
                        <div class="price">
                            <p>Price: <span class="value"><?php echo $row["price"];?></span></p>
                        </div>
                        <div class="company-product-info">
                            <p>
                                Overview:
                                <span class="value">
                    ...
                    <div class="col-xs-12">
                            ...
                            <div class="buttons">
                        <?php
                        echo"<a href=\"save-admin.php?IDp=".$row['ID']."\" class=\"btn btn-primary\" id=\"save_product\">Save Product</a>";
                        echo"<a href=\"delete-admin.php?IDp=".$row['ID']."\" class=\"btn btn-info\" id=\"cancle_button\">Cancel Product</a>";
                        ?>
                       </div>        
                    </div>
                 </div>   
            ...
            <?php
                            ...
                            echo "Nuk gjindet asnje kompani per regjistrim !";
                        }
                        $conn->close();
                        ?>
            <div class="brands">
