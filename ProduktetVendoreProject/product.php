...
<html lang="en">
  ...
  <body>
    ...
    <div class="content">
        ...
        $sql="SELECT ID, product_name, product_category, product_image, product_id,product_info,price FROM company_add Orders WHERE ID='$id'";   
            ...
            while($row = $result->fetch_assoc()) { 
               ...
               // $product_image=$row['product_image'];
                ...
                <div class="about-content product-page">
                   ...
                   <!--         <img src="images/blejshqip.jpg" alt="Product Image"> -->
                            <h3>Product Name: </h3>
                    ...
                    <?php
                           ...
                           if(isset($_SESSION['logged_in']))
                        {
                           echo"<a href=\"modify_product.php?IDp=".$row["ID"]."\" class=\"btn btn-info\">modify</a>";
                        }
